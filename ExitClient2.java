...
public static void main(String args[]) throws IOException{
		...
		System.out.println("[EXIT CLIENT 2] Up and running! Please type the car you wish to leave by using the following syntax: \"exit x y\" where x is the car's number and y the entrance where it came from (either 1 or 2).");
